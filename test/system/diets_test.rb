...
class DietsTest < ApplicationSystemTestCase
  ...
  test "creating a Diet" do
    ...
    fill_in "Doctor", with: @diet.doctor_id
    fill_in "Drink", with: @diet.drink
    fill_in "Exercise", with: @diet.exercise
    fill_in "Food", with: @diet.food
    fill_in "Mental", with: @diet.mental
