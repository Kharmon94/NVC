...
class DietsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diet" do
    assert_difference('Diet.count') do
      post diets_url, params: { diet: { doctor_id: @diet.doctor_id, drink: @diet.drink, exercise: @diet.exercise, food: @diet.food, mental: @diet.mental, user_id: @diet.user_id } }
    end
  ...
  test "should update diet" do
    patch diet_url(@diet), params: { diet: { doctor_id: @diet.doctor_id, drink: @diet.drink, exercise: @diet.exercise, food: @diet.food, mental: @diet.mental, user_id: @diet.user_id } }
