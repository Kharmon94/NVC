...
class DiagnosesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create diagnosis" do
    assert_difference('Diagnosis.count') do
      post diagnoses_url, params: { diagnosis: { doctor_id: @diagnosis.doctor_id, location: @diagnosis.location, name: @diagnosis.name, stage: @diagnosis.stage, type: @diagnosis.type, user_id: @diagnosis.user_id } }
    end
  ...
  test "should update diagnosis" do
    patch diagnosis_url(@diagnosis), params: { diagnosis: { doctor_id: @diagnosis.doctor_id, location: @diagnosis.location, name: @diagnosis.name, stage: @diagnosis.stage, type: @diagnosis.type, user_id: @diagnosis.user_id } }
