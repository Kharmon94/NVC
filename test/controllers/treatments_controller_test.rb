...
class TreatmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create treatment" do
    assert_difference('Treatment.count') do
      post treatments_url, params: { treatment: { doctor_id: @treatment.doctor_id, dosage: @treatment.dosage, name: @treatment.name, schedule: @treatment.schedule, time: @treatment.time, user_id: @treatment.user_id } }
    end
  ...
  test "should update treatment" do
    patch treatment_url(@treatment), params: { treatment: { doctor_id: @treatment.doctor_id, dosage: @treatment.dosage, name: @treatment.name, schedule: @treatment.schedule, time: @treatment.time, user_id: @treatment.user_id } }
